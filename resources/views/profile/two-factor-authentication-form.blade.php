<x-action-section>
    ...
    <x-slot name="content">
        <h3 class="text-lg font-medium text-dark dark:text-light">
            @if ($this->enabled)
        ...
        <div class="mt-3 max-w-xl text-sm text-dark dark:text-light">
            <p>
        ...
        @if ($this->enabled)
            @if ($showingQrCode)
                <div class="mt-4 max-w-xl text-sm text-dark dark:text-light">
